  ...
  return (
    <div className="min-h-screen bg-slate-900">
      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        ...
        {/* Value Exchange Education - Two-Way Street */}
        <motion.div
          ...
          <div className="relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-5">
              ...
              <motion.div
                ...
                className="bg-slate-900/50 rounded-xl p-5 border border-emerald-500/30"
              >
              ...
              <motion.div
                ...
                className="bg-slate-900/50 rounded-xl p-5 border border-amber-500/30"
              >
                <div className="flex items-center gap-2 mb-4">
            ...
            <motion.div
              ...
              className="mt-6 p-4 bg-gradient-to-r from-amber-500/10 via-orange-500/10 to-rose-500/10 rounded-xl border border-amber-500/20"
            >
