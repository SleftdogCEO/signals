...
function generateAdditionalGeneralTopics(): GeneralTopic[] {
  const topics: { title: string; slug: string; excerpt: string; category: string; meta: string; contentKey: string }[] = [
    ...
    { title: "Dental Referral Strategies: General Dentists, Orthodontists, and Oral Surgeons", slug: "dental-referral-strategies-general-orthodontists-oral", excerpt: "The dental referral triangle is one of the most active in healthcare. How general dentists, orthodontists, and oral surgeons build profitable referral loops.", category: "Referral Strategy", meta: "Dental referral strategies for general dentists, orthodontists, and oral surgeons. Build profitable cross-referral relationships.", contentKey: "dental" },
    ...
    { title: "Referral Network Building for Physical Therapists", slug: "referral-network-building-physical-therapists", excerpt: "Physical therapists depend on referrals more than almost any other specialty. Here is the complete playbook for PT referral network building.", category: "Referral Strategy", meta: "Complete referral network building guide for physical therapists. Strategies for PT practices to grow through provider referrals.", contentKey: "ptNetwork" },
    ...
    { title: "Referral Network Building for Med Spas and Aesthetic Practices", slug: "referral-network-building-med-spas-aesthetic", excerpt: "Med spas grow fastest through provider referrals, not Instagram. Here is how to build referral relationships with dermatologists, OB-GYNs, and PCPs.", category: "Referral Strategy", meta: "Referral network building guide for med spas and aesthetic practices. Build partnerships with dermatologists, OB-GYNs, and PCPs.", contentKey: "medSpa" },
    ...
    { title: "Referral Patterns for Chiropractors: Beyond the PCP Connection", slug: "referral-patterns-chiropractors-beyond-pcp", excerpt: "Chiropractors get most referral advice focused on PCPs. But the data shows other referral corridors with even higher conversion rates.", category: "Referral Strategy", meta: "Referral patterns for chiropractors beyond PCP connections. Alternative referral corridors with high conversion rates.", contentKey: "chiroPatterns" },
    ...
    { title: "Referral Partnerships Between Medical and Dental Practices", slug: "referral-partnerships-medical-dental-practices", excerpt: "The medical-dental referral corridor is growing as oral-systemic health connections become clearer. How to bridge these two worlds.", category: "Referral Strategy", meta: "How to build referral partnerships between medical and dental practices. The growing medical-dental referral corridor.", contentKey: "medDental" },
