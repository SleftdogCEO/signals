...
export function Pricing({
  ...
  description = "Choose the plan that works for you. Get started at no cost.",
}: PricingProps) {
  ...
  return (
    <div className="w-full py-20">
      <div className="container mx-auto px-4">
        <header className="text-center space-y-4 mb-12 max-w-4xl mx-auto">
        ...
        <div className="flex justify-center items-center">
          <div className="w-full max-w-7xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 place-items-center md:place-items-stretch">
              {plans.map((plan, idx) => (
                <motion.div
                  key={plan.name}
                ...
                >
                  ...
                  <p className="mt-6 text-xs text-gray-400 text-center">{plan.description}</p>
                </motion.div>
              ))}
            </div>
          </div>
